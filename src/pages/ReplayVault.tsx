...
function ProtectedReplayVault() {
  ...
  const hasVaultAccess = canUseVault(access);
  ...
  useEffect(() => { if (hasVaultAccess) headingRef.current?.focus({ preventScroll: true }); }, [hasVaultAccess]);
