...
export const MASTERMIND_SUCCESS_STAGES: MastermindRoadmapStage[] = [
  {
    ...
    resources: [
      ...
      { resourceId: 'money-move-day-one', title: 'Find Your Next Money Move', access: 'Core', useWhen: 'Use this when you have too many possible offers or revenue streams and need to choose the one that matters now.', portalPath: 'Core curriculum -> Find Your Next Money Move', afterWatching: 'Name the buyer, the paid problem, and the money move you are choosing this week.', milestoneIds: ['offer-buyer'] },
  ...
  },
  {
    ...
    resources: [
      ...
      { resourceId: 'great-marketing-breakthrough-day-three', title: 'Great Marketing Breakthrough: Follow Your Plan', access: 'Core', useWhen: 'Use this when audience behavior needs to become a strategic next test.', portalPath: 'Core curriculum -> Find + Nurture -> Great Marketing Breakthrough Day Three', afterWatching: 'Review replies, clicks, questions, and buying signals, then choose one next experiment.', milestoneIds: ['nurture-evaluate'] },
    ],
  ...
  },
  {
    ...
    resources: [
      ...
      { resourceId: 'bosses-make-sales-day-one', title: 'Bosses Make Sales: Day One', access: 'Core', useWhen: 'Use this when the offer needs real invitations, not more private asset editing.', portalPath: 'Core curriculum -> Sell -> Bosses Make Sales Day One', afterWatching: 'Send the first invitations and schedule follow-up before changing the offer.', milestoneIds: ['sell-run'] },
