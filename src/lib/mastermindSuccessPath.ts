...
export const MASTERMIND_SUCCESS_STAGES: MastermindRoadmapStage[] = [
  {
    ...
    resources: [
      { resourceId: 'money-move-day-one', title: 'Choose Your Money Move', access: 'Core', useWhen: 'Use this when too many ideas, possible offers, or backend projects are keeping you from choosing the next sellable move.', portalPath: 'Core curriculum -> Offer -> Choose Your Money Move', afterWatching: 'Write the one offer or revenue stream you are choosing this quarter, who it is for, and the easiest useful way to test it this week.', milestoneIds: ['offer-focus'] },
      { resourceId: 'wibn-offer-clarity', title: 'Offer Clarity', access: 'Core', useWhen: 'Use this when you have an offer idea, but the buyer, paid problem, or why-now reason is still fuzzy.', portalPath: 'Core curriculum -> Offer Clarity', afterWatching: 'Write the buyer, paid problem, and why-now reason in language a real person would recognize.', milestoneIds: ['offer-buyer'] },
