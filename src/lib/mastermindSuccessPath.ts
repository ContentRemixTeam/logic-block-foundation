...
export const MASTERMIND_SUCCESS_STAGES: MastermindRoadmapStage[] = [
  {
    ...
    resources: [
      ...
      { resourceId: 'messy-action-sprints', title: 'Implementation Support', access: 'Core', useWhen: 'Use this when the offer needs to become a real invitation instead of more private thinking.', portalPath: 'Learning -> Messy Action Sprints' },
    ],
  ...
  },
  {
    ...
    resources: [
      ...
      { resourceId: 'messy-action-sprints', title: 'Implementation Support', access: 'Core', useWhen: 'Use this when the fastest path is sending the offer and collecting evidence this week.', portalPath: 'Learning -> Messy Action Sprints' },
