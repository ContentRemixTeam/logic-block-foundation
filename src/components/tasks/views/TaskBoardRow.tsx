...
import { Calendar, MoreHorizontal, Trash2, FileText, FolderKanban } from 'lucide-react';
...
export function TaskBoardRow({
  ...
  return (
    <div 
      className="flex items-center hover:bg-muted/30 border-t group cursor-pointer"
      onClick={onClick}
    >
