...
export default function MastermindVideoSearch() {
  ...
  return <div className="space-y-6" data-replay-vault-pilot>
    ...
    {isLoading && <p role="status" aria-live="polite" className="text-sm text-muted-foreground">Reading your 90-day focus and current planner...</p>}
