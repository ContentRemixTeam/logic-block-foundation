...
const MastermindHiddenDraft = lazyWithRetry(() => import('./pages/MastermindHiddenDraft'));
                ...
                <ArcadeProvider>
                  ...
                  <SeasonalEffectsProvider>
                    ...
                    <Routes>
                      ...
                      <Route path="/admin/mastermind-hidden-draft" element={<ProtectedRoute><AdminPreviewGate><PageSuspense><MastermindHiddenDraft /></PageSuspense></AdminPreviewGate></ProtectedRoute>} />
