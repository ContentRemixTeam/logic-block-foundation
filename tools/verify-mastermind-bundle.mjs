...
const requiredMastermindHubStrings = [
  ...
  'core lessons being added next',
  'ready to watch',
  'Being added to this app',
  'Being added next',
  'Ready videos are still being added here.',
  'video is ready and tested',
  'Search only finds ready videos; planned lessons appear in section cards.',
  'Ready soon',
  'Action step',
