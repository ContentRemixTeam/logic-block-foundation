...
const requiredMastermindHubStrings = [
  ...
  'Use your own AI without spending app credits',
  ...
  'Confirm this monthly unlock',
  'Confirm project pack',
  'Monthly unlock confirmed',
  'Saving confirmation to this app account',
  'No unlock was used; try again',
  'No second unlock was used',
  'confirm_my_mastermind_ai_asset_unlock',
  'mastermind_ai_asset_unlocks',
  'Confirm this monthly unlock to generate this section',
  'Confirm this monthly unlock to copy the install-ready version',
  'This confirms which project pack you are choosing to build next.',
  ...
  'Setup interview',
  'Setup Interview To Answer',
  'Output Quality Benchmark',
  'Source Labels And Contradictions',
  ...
  'ready to watch',
  'Start with the action step here.',
  'Search only finds videos that are ready to watch.',
  'Action step',
