...
AS $function$
  WITH input AS (
    ...
    SELECT r.portal_resource_id, s.id moment_id, r.title, r.product_title, r.category_title,
      r.resource_type, s.transcript_text_private, s.starts_at_ms, s.ends_at_ms,
