...
GRANT SELECT ON public.low_battery_workshop_answer_versions TO authenticated;
GRANT ALL ON public.low_battery_workshop_answer_versions TO service_role;

ALTER TABLE public.low_battery_workshop_answer_versions ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "Users can view their low battery answer history" ON public.low_battery_workshop_answer_versions;
