...
COMMENT ON FUNCTION public.search_mastermind_media_resources(uuid,text,text,text,integer,integer,boolean,text,boolean,timestamp with time zone)
  IS 'Surface-aware protected media search for core curriculum, current 30-day replays, and annual/lifetime Replay Vault without leaking private source fields.';
